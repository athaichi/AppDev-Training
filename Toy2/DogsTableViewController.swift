...
class DogsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "DogsCell", for: indexPath) as! DogsTableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "DogDetailSegue") {
            ...
            DestVC.age = String(Dog.DogsArr[row!].age) + "year(s)-old"
            DestVC.type = Dog.DogsArr[row!].type
            DestVC.image = Dog.DogsArr[row!].image
